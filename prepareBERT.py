...
# When BERT instead of BERT, change filenames. Not possible with flags, as "xtilly" differs
# <editor-fold desc="Combining embedding files, retrieved with 'getBERTusingColab">
temp_filenames_Large = ['/data/temporaryData/temp_BERT/BERT1till227.txt',
                  '/data/temporaryData/temp_BERT/BERT227till300.txt',
                  '/data/temporaryData/temp_BERT/BERT300till865.txt',
                  '/data/temporaryData/temp_BERT/BERT865till951.txt',
                  '/data/temporaryData/temp_BERT/BERT951till1000.txt',
                  '/data/temporaryData/temp_BERT/BERT1000till1479.txt',
                  '/data/temporaryData/temp_BERT/BERT1479till1800.txt',
                  '/data/temporaryData/temp_BERT/BERT1800till2000.txt',
                  '/data/temporaryData/temp_BERT/BERT2000till2369.txt',
                  '/data/temporaryData/temp_BERT/BERT2369till2530.txt']
...
count_sentences=0
with open('BERT_2016embedding.txt','w') as outf:
...
count_sentences=0
with open('BERT_2016embedding_withCLS_SEP.txt','w') as outf:
    for tfname in temp_filenames_Large:
        print(tfname)
        with open(tfname) as infile:
            for line in infile:
...
unique_words = []
unique_words_index = []
with open('BERT_2016embedding_withCLS_SEP.txt') as BERTemb_sep:
...
counter = 0
uniqueVocaBERT=[]
with open('BERT_2016embedding.txt') as BERTemb:
...
# </editor-fold>,
#BERT_2016.1024.txt is now the embedding matrix with all the unique words. Shape = (44638,768)
